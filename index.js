...
app.post('/add', async (req, res) => {
    try {
        ...
        await db.query(query, [title, author, isbn || null, rating || null, notes, date_read || null, coverUrl]);
        res.redirect('/');
    } catch (error) {
...
app.post('/edit/:id', async (req, res) => {
    try {
        ...
        await db.query(query, [title, author, isbn || null, rating || null, notes, date_read || null, coverUrl, bookId]);
        res.redirect('/');
    } catch (error) {
